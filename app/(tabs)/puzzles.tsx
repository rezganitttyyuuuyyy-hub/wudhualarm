...
const allPuzzles = [
  ...
  { id: 19, difficulty: 'سهل', question: 'ما هو الحيوان الذي صبر معه نبي الله أيوب؟', options: ['الجمل', 'لا يوجد حيوان محدد', 'الناقة', 'الكلب'], correct: 'لا يوجد حيوان محدد' },
  ...
  { id: 46, difficulty: 'سهل', question: 'ما هو يوم الجمعة؟', options: ['يوم أسبوعي مبارك', 'يوم صيام', 'يوم عيد الفطر', 'يوم عرفة'], correct: 'يوم أسبوعي مبارك' },
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>أكثر من 50 سؤالاً متنوعاً واكسب 1.5 نقطة لكل إجابة</Text>
      </View>
